...
import '../../features/user_account_with_plan/models/user_account_hive_model.dart';

class HiveService {
  static Future<void> initHive() async{
    var dir = await getApplicationDocumentsDirectory();
    Hive.init(dir.path);
    Hive.registerAdapter(UserAccountHiveModelAdapter());
    Hive.registerAdapter(ReminderHiveModelAdapter());
    Hive.registerAdapter(ScheduleHiveModelAdapter());

    await Future.wait([
      Hive.openBox<UserAccountHiveModel>('user_account_box'),
      Hive.openBox("plan_settings"),
  ...
  /// >>>> Access All box ======================================================
  static Box<UserAccountHiveModel> get userAccountBox => Hive.box<UserAccountHiveModel>('user_account_box');
  static Box get planSettingsBox => Hive.box('plan_settings');
