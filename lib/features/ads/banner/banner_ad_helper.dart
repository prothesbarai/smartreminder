...
class BannerAdHelper {
  ...
  static Future<BannerAd?> createAdaptiveBanner(BuildContext context, {int maxRetries = 3, int initialDelaySeconds = 2,}) async {
    if (!AdsConfig.adsEnabled || !AdsConfig.bannerEnabled) return null;
